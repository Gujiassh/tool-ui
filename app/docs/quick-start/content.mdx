...
<Alert className="squircle my-6 flex max-w-2xl flex-col gap-3 rounded-4xl border-sky-300 bg-sky-50/50 dark:border-sky-950 dark:bg-sky-950/20">
  ...
  <AlertDescription className="my-0! py-0! text-pretty text-sky-800 dark:text-sky-100">
