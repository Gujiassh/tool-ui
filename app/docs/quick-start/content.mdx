...
<DocsHeader
  title="Quick Start"
  description="Go from raw JSON to a rendered component in your chat app."
...
The example above is a **display-only** component — the tool returns data, and the component renders it. Some components go further: they let the user make a choice that flows back to the assistant.
