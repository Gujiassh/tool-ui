...
<Alert className="my-6 border-cyan-200 bg-cyan-50 text-cyan-900 dark:border-cyan-900 dark:bg-cyan-950/30 dark:text-cyan-100">
  <Bot />
  <AlertDescription className="text-cyan-900 dark:text-cyan-100">
    Skills are now available for coding agents. See{" "}
