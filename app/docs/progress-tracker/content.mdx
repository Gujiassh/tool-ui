...
<TypeTable
  type={{
    ...
    responseActions: {
      description:
        "Actions rendered below the card (e.g., Cancel, Retry). Custom actions render in interactive mode even after completion/failure; default cancel is hidden once completed or failed.",
