...
export const toolkit: Toolkit = {
  ...
  render: ({ args, result, status, addResult, toolCallId }) => {
    ...
    >({
      ...
      result,
      safeParseArgs: safeParseSerializableApprovalCard,
      loadingMessage: "Loading approval…",
      awaitingActionMessage: "Awaiting approval",
    });
    ...
    return (
      <ApprovalCardErrorBoundary>
        {state.kind === "partial" || state.kind === "ready" ? (
          <ApprovalCard {...state.args} choice={state.result} />
        ) : (
          <ApprovalCard
            {...state.args}
