...
- `index.ts` or `index.tsx`: Public exports (component, types, parser, error boundary)
...
8. `index.tsx`: Export the public API (component, types, strict/safe parsers, error boundary)
