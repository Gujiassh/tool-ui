...
When a user approves a deploy, selects a plan, or confirms a purchase, the interactive UI should become a permanent record of what happened. Otherwise, scrolling back shows a clickable button for a decision that was already made. A **receipt state** replaces the interactive controls with a confirmation of the choice, proof of the decision that the assistant can reference later.
...
Components with built-in receipt states:
