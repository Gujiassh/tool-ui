...
export function mergeTunedPresets(
  ...
  const conditions = new Set<WeatherCondition>([
    ...(Object.keys(base) as WeatherCondition[]),
    ...(Object.keys(delta) as WeatherCondition[]),
  ]);
...
export function buildCanonicalToolUiPresetsForEditedConditions(
  editedCheckpointOverrides: Partial<Record<WeatherCondition, CheckpointOverrides>>,
  repoCheckpointOverrides: Partial<Record<WeatherCondition, CheckpointOverrides>>,
): WeatherEffectsTunedPresets {
