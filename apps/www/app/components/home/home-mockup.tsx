...
export function HomeMockup() {
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-x-0 -bottom-12 -z-10 h-32 bg-[radial-gradient(ellipse_at_center,_oklch(0_0_0_/_0.08),_transparent_70%)] blur-2xl"
        aria-hidden="true"
      />
